...
## Overview
This app provides provides a Socket.IO input which hosts a [Socket.IO](http://socket.io) server that can receive large volumes (tens of thousands per second) of events realtime which will be fed into Splunk.
